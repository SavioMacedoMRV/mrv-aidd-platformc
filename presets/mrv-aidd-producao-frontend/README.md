...
- No modo **maestro**, o `/specify` gera USs de ambos os ownerships (frontend e backend) no mesmo spec, e o `/sincronizar` replica spec e contratos para os repositórios pareados.

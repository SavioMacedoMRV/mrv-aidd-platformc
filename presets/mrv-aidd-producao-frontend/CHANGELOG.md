...
- Comando `speckit.specify` agora detecta `maestro-config.json` e ativa modo dual-ownership: quando o repositorio e maestro, gera historias de frontend e backend no mesmo `spec.md` em vez de registrar backend em `## Backend Follow-up`.
